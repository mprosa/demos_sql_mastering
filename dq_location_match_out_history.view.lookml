- view: dq_location_match_out_history
  sql_table_name: DQ_LOCATION_MATCH_OUT_HISTORY
  fields:
  ...
  - dimension: match_pass_10_break_key
    type: string
    sql: ${TABLE}.MATCH_PASS_10_BREAK_KEY

  - dimension: match_pass_10_criterion
    type: string
    sql: ${TABLE}.MATCH_PASS_10_CRITERION

  - dimension: match_pass_10_grp_num
    type: string
    sql: ${TABLE}.MATCH_PASS_10_GRP_NUM

  - dimension: match_pass_10_level
    type: string
    sql: ${TABLE}.MATCH_PASS_10_LEVEL

  - dimension: match_pass_10_score
    type: string
    sql: ${TABLE}.MATCH_PASS_10_SCORE

  - dimension: match_pass_10_status
    type: string
    sql: ${TABLE}.MATCH_PASS_10_STATUS

  - dimension: match_pass_10_type
    type: string
    sql: ${TABLE}.MATCH_PASS_10_TYPE
  ...
  - dimension: post_duns_number
    type: string
    sql: ${TABLE}.POST_DUNS_NUMBER

  - dimension: post_fax_id
    type: number
    sql: ${TABLE}.POST_FAX_ID

  - dimension: post_location_nm
    type: string
    sql: ${TABLE}.POST_LOCATION_NM

  - dimension: post_master_location_id
    type: number
    sql: ${TABLE}.POST_MASTER_LOCATION_ID

  - dimension: post_mdr_pid
    type: string
    sql: ${TABLE}.POST_MDR_PID

  - dimension: post_phone_full
    type: string
    sql: ${TABLE}.POST_PHONE_FULL

  - dimension: post_phone_id
    type: number
    sql: ${TABLE}.POST_PHONE_ID
