- view: vw_f_message_event_norm
  sql_table_name: VW_F_MESSAGE_EVENT_NORM
  fields:
  ...
  - dimension: source_message_instance_event_id
    type: string
    sql: ${TABLE}.SOURCE_MESSAGE_INSTANCE_EVENT_ID

  - dimension: source_message_instance_id
    type: string
    sql: ${TABLE}.SOURCE_MESSAGE_INSTANCE_ID
