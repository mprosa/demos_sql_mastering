- view: dq_individual_std
  sql_table_name: DQ_INDIVIDUAL_STD
  fields:
  ...
  - dimension: std_dual_nm
    type: string
    sql: ${TABLE}.STD_DUAL_NM
  ...
  - dimension: std_first_nm_person2
    type: string
    sql: ${TABLE}.STD_FIRST_NM_PERSON2
  ...
  - dimension: std_last_nm_person2
    type: string
    sql: ${TABLE}.STD_LAST_NM_PERSON2

  - dimension: std_middle_nm
    type: string
    sql: ${TABLE}.STD_MIDDLE_NM

  - dimension: std_middle_nm_person2
    type: string
    sql: ${TABLE}.STD_MIDDLE_NM_PERSON2
